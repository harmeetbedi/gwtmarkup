...
public  class QuickTipFactory extends ToolTipFactory {
    /** tag used in XML file to lookup factory */
    public static final String XML_TAG = "QuickTip";
    
    public QuickTipFactory() {
    }

    @SuppressWarnings("unchecked")
    protected void registerAttributes() {
        super.registerAttributes();
        register("interceptTitles", new BooleanAttributeSetter<QuickTip>() {
            public void set(QuickTip widget, Element element, String name, boolean value) {
                widget.setInterceptTitles(value);
            }
        });
    }
    ...
    @Override
    protected QuickTip newInstance(Element element) {
        throw new RuntimeException("override to create instance with arguments");
    }
    
    public QuickTip create(java.util.List<Object> ancestors,final Element element) {
        final QuickTip item = (QuickTip)createInstance(element);
        new WidgetDOMConverter<QuickTip>(ancestors,item,element) {
            @Override
